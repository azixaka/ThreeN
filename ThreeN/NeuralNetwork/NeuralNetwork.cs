...
public sealed class NeuralNetwork
{
    ...
    private NeuralNetwork(Matrix<float>[] weights, Matrix<float>[] biases, Matrix<float>[] activations)
    {
        Weights = weights;
        Biases = biases;
    ...
    public static NeuralNetwork Create(params int[] configuration) // {2, 2, 1}
    {
