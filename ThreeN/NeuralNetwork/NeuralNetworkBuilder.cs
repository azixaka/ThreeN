...
{
    private readonly List<(int neurons, Activation activation)> _layers = new();
    ...
    public NeuralNetworkBuilder WithHiddenLayer(int neurons, Activation activation)
    {
    ...
    /// <returns>This builder for method chaining.</returns>
    /// <exception cref="ArgumentException">If neurons is &lt;= 0.</exception>
    public NeuralNetworkBuilder WithOutputLayer(int neurons, Activation activation)
    {
    ...
    public NeuralNetwork Build()
    {
        ...
        var activations = new Activation[_layers.Count];
